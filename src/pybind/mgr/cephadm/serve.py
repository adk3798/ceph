    ...
    def _check_daemons(self) -> None:
        ...
        for dd in daemons:
            ...
            if not last_config:
                ...
                self.log.debug(f'{dd.name()} container cli args {dd.extra_container_args} -> {spec.extra_container_args}')
        ...
        with set_exception_subject('service', orchestrator.DaemonDescription(
            ...
            try:
                ...
                try:
                    ...
                    if eca:
                        daemon_spec.extra_args.append('--extra-container-args')
                        daemon_spec.extra_args.append(json.dumps(eca))
